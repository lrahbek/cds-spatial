...
#What kind of coordinate system does it use? ## northering, eastering

places_sf
#What type of data does it store? 
#How many attributes does it contain? #6
#What is its geometry? ## points 
#What kind of coordinate system does it use? #longtitude, lattitude 
...
# /Start Code / #
#option 1
nitrates4326 <- nitrates25832 %>% st_set_crs(4326)

plot(nitrates4326$WKT, col = "hotpink");plot(places4326$geometry, col = "green", add =T)
...
plot(nitrates25832$WKT, col = "hotpink");plot(elevation25832$geometry, col = "green", add =T)
