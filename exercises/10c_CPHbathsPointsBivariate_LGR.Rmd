...
st_crs(baths_hist) #unit is meter
st_crs(baths_osm) #unit is meter
...
```{r nn-hist}
hist(nn.sim,breaks=30, main = "Simulating nearest neighbour distances");abline(v=mean(nncross(split(b_ppp)$OSM,split(b_ppp)$HIST)$dist),col="red")
```
