...
tm_shape(elevation)  +
  ...
  tm_compass(position = c("RIGHT", "top"),
             type = "rose", 
             size = 2) +
  tm_credits(text = "L.G. Rahbek, 20-02-2024") +
...
nitrates_sf
#What type of data does it store? 
#How many attributes does it contain? #18
#What is its geometry? ## points
#What kind of coordinate system does it use? ## northering, eastering, crs is NA

places_sf
#What type of data does it store? 
#How many attributes does it contain? #6
#What is its geometry? ## points 
#What kind of coordinate system does it use? #longtitude, lattitude , crs is na 


#Display the `elevation` object and view its structure.
elevation
#What type of data does it store? 
#What is the coordinate system used? +proj=longlat +ellps=WGS84 +no_defs 
#How many attributes does it contain?
#How many dimensions does it have? ## 396, 876, 346896 
#What is the data resolution? #0.008333333, 0.008333333
...
plot(nitrates4326["WKT"], col = "hotpink");plot(places4326["geometry"], col = "green", lwd = 10, add = T)

#option 2
elevation25832 <- projectRaster(elevation, crs = 25832)
places25832 <- st_transform(places4326, crs = 25832)

plot(nitrates25832["WKT"], col = "hotpink")
plot(elevation25832["geometry"], col = "green")


library(tmap)

tm_shape(elevation25832) + 
  tm_raster(title = "elev (masl)", 
            style = "cont",
            palette = "RdYlGn") +
  tm_shape(nitrates25832) + 
  tm_dots(col = "red") + 
  tm_shape(places25832) +
