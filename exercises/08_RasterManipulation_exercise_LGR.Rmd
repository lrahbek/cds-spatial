...
#align crs of elevation raster and mounds shapefile
st_crs(mounds)
st_crs(elevation_reclass)

#bounding box around the mounds
mounds_bb = st_make_grid(mounds, n = 1)

#plot mounds and bbox together 
plot(st_geometry(mounds));plot(mounds_bb, add = T)

#crop elevation_reclass to the mounds obj 
elev = crop(elevation_reclass, mounds)

#plot mounds, mounds_bb and elev
plot(elev);plot(st_geometry(mounds), add = T);plot(mounds_bb, add = T)
